...
<html>
    <head> <title> Test_SHIPPON </title> 
        <link rel="shortcut icon" href="image/logo_company.jfif" type="image/png" >
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="padding: 50px; border: 1px solid black">
                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-sm-10" style="padding: 10px; border: 1px solid black; height: 500px; text-align: center" >
                            <lable id="show_list_number"></lable><br>
                            <lable id="show_number"></lable><br>
                            <div style="overflow: auto; font-size:18px;height: 380px; margin-top: 10px">
                                <strong id="show_sesult" ><br></strong>
                            <div>
                        </div>
                    </div>
                </div>
