...
if($_GET['type_search']){
    ...
    if($_GET['type_search'] == 'Linear'){
        Linear($_POST['search_list_number'], $_POST['search_number']);
    }

    if($_GET['type_search'] == 'Binary'){
        Binary($_POST['search_list_number'], $_POST['search_number']);
    }

    if($_GET['type_search'] == 'Bubble'){
        Bubble($_POST['search_list_number']);
    }

}

function Linear($search_list_number, $search_number){
    $output = [];
    $output['error'] = '0';
    $output['msg'] = 'OK.';
...
function Binary($search_list_number, $search_number){
    $output = [];
    $output['error'] = '0';
    $output['msg'] = 'OK.';
    $output['result'] = 'Result !!!!<br>';
...
function Bubble($search_list_number){
    $output = [];
    $output['error'] = '0';
    $output['msg'] = 'OK.';
    $output['result'] = 'Result !!!!<br>';
